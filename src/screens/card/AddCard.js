...
const AddCard=()=>{
    return(
        ...
        <Text style={styles.Desc} >We accept Credit and Debit cards from Visa,Masterard, American Express, Sodexo, Rupay,Maestro & Diners</Text>
        <WelcomeScreenPhoneNumInp placeholder={"Enter Card Number"}  style={styles.inputBox}/>
        <WelcomeScreenNameInput placeholder={"Enter Name on Card"}  style={styles.inputBox}/>
        <View style={styles.Box}>
        <WelcomeScreenPhoneNumInp placeholder={"Valid(MM/YY)"}  style={styles.dateInp}/>
        <WelcomeScreenPhoneNumInp placeholder={"CVV"}  style={styles.CVVInput}/>
        </View>
        <Text style={styles.Desc} >We will save this card for your convenience. If required, you can remove the card in the ‘Payments’ section. We do not save your CVV.</Text>
