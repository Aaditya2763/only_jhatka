...
const AddUpiScreen=()=>{
  ...
  <Text style={styles.Desc} >Enter your verified UPI ID to pay and proceed to order your items</Text>
  <WelcomeScreenNameInput placeholder={"Enter UPI ID"} source={Check} style={styles.inputBox}/>
  <HeaderTitle title={"Suggetions"} style={styles.heading}/>
  <View style={styles.imgContainer}>
    <Image style={styles.img} source={require('../../assets/images/gpay.png')} />
    <Image style={styles.img} source={require('../../assets/images/phonepe.png')}  />
    <Image style={styles.img} source={require('../../assets/images/paytm.png')} />
  </View>
        </View>
    )
}
