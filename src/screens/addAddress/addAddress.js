...
<NetBAnkingSearchBar placeholder={" Search for area,street..."} style={styles.SearchBar} />
<DetailsCard title={"Delivery Address"} desc={"Lorem Ipsom Dolor Amet...."} source={SelectLocation}/>
        <DetailsCard title={"Delivery Address"} desc={"Lorem Ipsom Dolor Amet...."} source={SelectLocation}/>
        </View>
