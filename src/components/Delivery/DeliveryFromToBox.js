    ...
    return(
        <View style={styles.container}>
            <View style={styles.sourceBox}>
                <Image source={require('../../assets/icons/deliveryIcons/source.png')} style={styles.img} />
                <Text style={{color:'black',fontSize:16}}> From | </Text> 
                <TextInput placeholder={"Delivery in 35 min"} style={styles.input} /> 
            </View>
            <Image source={require('../../assets/icons/deliveryIcons/Line.png')} style={styles.lineImg} />
            <View style={styles.sourceBox}>
                <Image source={require('../../assets/icons/deliveryIcons/destination.png')} style={styles.img}/>
                <Text style={{color:'black',fontSize:16}}>{" To |"}</Text>
                <TextInput placeholder={"Lorem Ipsom dolor amet...."} style={styles.input}/>
            </View>
        </View>
    )
}
